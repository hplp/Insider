...
void interconnects() {
    ...
    app_intg_matcher(app_input_params, app_input_data, app_intg_writer_input_param, app_intg_verifier_input_param, app_intg_mat_rdc_input);
    app_intg_mat_rdc(app_intg_mat_rdc_input, app_intg_verifier_input_record);
    app_intg_verifier(app_intg_verifier_input_param, app_intg_verifier_input_record, app_intg_rdc_input_32to16);
    ...
    app_intg_writer(app_intg_writer_input_param, app_intg_writer_input_record, app_output_data);
