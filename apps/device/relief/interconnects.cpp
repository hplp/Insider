...
void interconnects() {
    ...
    app_rlf_dspt(app_input_params, app_input_data, app_rlf_upd_input_params, app_rlf_dist_input_params, app_rlf_diff_input_params, app_rlf_dist_input_data, app_rlf_flt16_input_data, app_rlf_max_vec_init);

    app_rlf_dist(app_rlf_dist_input_data, app_rlf_dist_input_params, app_rlf_rdc_16to8_input_data);
    ...
    app_rlf_max_vec(app_rlf_max_vec_input_data, app_rlf_stg_input_data, app_rlf_max_vec_init);
    app_rlf_stg(app_rlf_stg_input_data, app_rlf_diff_input_data);
    app_rlf_diff(app_rlf_diff_input_params, app_rlf_diff_input_data, app_rlf_upd_input_data);
    app_rlf_upd(app_rlf_upd_input_params, app_rlf_upd_input_data, app_rlf_flt16_input_params);
    app_rlf_flt16(app_rlf_flt16_input_params, app_rlf_flt16_input_data, app_rlf_flt8_input_data);
