...
void interconnects() {
    ...
    app_sql_input_parser(app_input_data, app_input_params, app_sql_filter0_input_records, app_sql_filter1_input_records, app_sql_filter0_params, app_sql_filter1_params);
    app_sql_filter0(app_sql_filter0_params, app_sql_filter0_input_records, app_sql_filter0_output_records);
    app_sql_filter1(app_sql_filter1_params, app_sql_filter1_input_records, app_sql_filter1_output_records);
    app_sql_writer(app_sql_filter0_output_records, app_sql_filter1_output_records, app_output_data);
}
