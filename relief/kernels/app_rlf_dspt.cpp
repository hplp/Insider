...
void app_rlf_dspt(
        ST_Queue<unsigned int> &app_rlf_input_params, 
...
#pragma HLS unroll
                    ...
                    dist_out.idx = readDataCnt & ((APP_FEATURE_DIM >> APP_FEATURE_PER_CYCLE_LOG2) - 1);
...
#pragma HLS unroll
                    ...
                    filter16_out.idx = readDataCnt & ((APP_FEATURE_DIM >> APP_FEATURE_PER_CYCLE_LOG2) - 1); 
